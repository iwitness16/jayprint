...
const navLinks = [
  ...
  { label: 'About JayPrint', href: '/about' },
  ...
  return (
    <header className="site-header">
      ...
      <div className="shell header-top">
        <Link href="/" className="brand-logo" aria-label="JayPrint home">
          ...
          <div className="brand-wordmark">
            <span className="brand-wordmark-name">JayPrint</span>
  ...
  return (
    <footer className="site-footer">
        ...
        <div className="shell footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-logo-wrap">
              <Link href="/" aria-label="JayPrint home"
                ...
                <div className="footer-logo-text">
                  <span className="footer-logo-name">JayPrint</span>
      ...
      <div className="shell footer-bottom">
        <span>Copyright © 2026, JayPrint, All Rights Reserved</span>
      </div>
