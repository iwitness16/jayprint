...
export default function AboutPage() {
  return (
    <>
      <SiteHeader active="About JayPrint" />
      <main>
        <PageHeader title="ABOUT JAYPRINT" />

        <div className="about-page shell">

          <h2>Who Is JayPrint?</h2>
          <p>
            JayPrint is one of the most trusted names in the premium fake ID industry. We have been
          ...
          <p>
            Unlike fly-by-night operations that appear and disappear overnight, JayPrint has
          ...
          <p>
            ...
            customers. Always verify you are on the correct JayPrint website. We will never ask you
