          ...
          <div className="contact-grid">
            ...
            <div className="contact-info">
              ...
              <div className="contact-social">
                <a href="https://wa.me/14028714160" className="social-btn social-wa" aria-label="Chat on WhatsApp" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://t.me/jayprint77" className="social-btn social-tg" aria-label="Message on Telegram" target="_blank" rel="noopener noreferrer">
                ...
                <a href="mailto:jayprint67@gmail.com" className="social-btn social-em" aria-label="Send an email">
