...
const ADMIN_WHATSAPP = '14028714160'
const ADMIN_TELEGRAM = 'jayprint77'
...
const allProducts = [
  ...
  // Canada
  { name: 'Quebec (QC) Fake ID',                           img: '/images/quebec-1.jpg',                  price: 'CA$95.00' },
  { name: 'British Columbia (B.C.) Fake ID',               img: '/images/british_columbia-1.jpg',        price: 'CA$95.00' },
  { name: 'Saskatchewan (SK) Fake ID',                     img: '/images/saskatchewan1.jpg',             price: 'CA$95.00' },
  { name: 'Manitoba (Man) Fake ID (2026 Version)',         img: '/images/manitoba-1.jpg',                price: 'CA$95.00' },
  { name: 'Alberta (Alta) Fake DL (2026 Version)',         img: '/images/alberta-1.jpg',                 price: 'CA$95.00' },
  { name: 'British Columbia (B.C.) Fake ID (2025 Version)', img: '/images/british_columbia_2025-1.jpg',   price: 'CA$95.00' },
  { name: 'Ontario (ON) Fake ID (2025 version)',           img: '/images/ontario-1.jpg',                 price: 'CA$95.00' },
  // UK
...
function OrdersInner() {
  ...
  function buildMessage(orderId: string, submittedAt: string) {
    return [
      ...
      ``,
      `_Sent from JayPrint order form_`,
    ].filter(Boolean).join('\n')
  }
  ...
  async function handleSubmit(e: React.FormEvent, channel: 'wa' | 'tg') {
    ...
    // ── 1. Save to Firestore BEFORE redirect ──
    //    Fire-and-forget — runs in the background even after
          ...
          <div className="orders-grid">
            ...
            <form className="orders-form" onSubmit={e => e.preventDefault()}>
              ...
              <div className="form-row">
                ...
                <input type="tel" placeholder="+1 (402) 871-4160" value={whatsapp} onChange={e => setWhatsapp(e.target.value)} required />
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '8px' }}>
                ...
                <p style={{ fontSize: '12px', color: 'var(--muted)', textAlign: 'center', lineHeight: '1.6' }}>
                  ...
                  <br />Order is saved to our system automatically.
                </p>
              </div>
            </form>
          </div>
